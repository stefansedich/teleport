---
title: How to Use Teleport in a Dedicated SSH Role with tsh
description: How to use Teleport in a dedicated SSH role with tsh.
---
...
>
  ![Example cluster arrangement](../../../img/server-access/openssh-proxy.2.svg)
</Figure>
